        ...
        <div className="relative mx-auto mt-16 max-w-3xl">
          ...
          <div className="relative mx-auto w-fit animate-float-slow">
            ...
            <img
              ...
              alt="LinkForge bio page running on a phone"
              className="relative z-[2] mx-auto h-auto w-[300px] sm:w-[340px] rounded-[40px] border border-white/20 shadow-[0_50px_120px_-30px_rgba(139,92,246,.55)]"
            />
